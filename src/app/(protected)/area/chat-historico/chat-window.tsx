    ...
    <Card className="h-full">
      <div className="border-b p-4">
        <h2 className="text-xl font-semibold">
          {selectedChat ? `Chat` : "Selecione um chat"}
        </h2>
      </div>

      <ScrollArea className="h-[calc(100vh-12rem)] flex-1 p-4">
        ...
        <div className="flex gap-2 border-t p-4">
          ...
          <Popover>
            ...
            <PopoverContent side="top" align="start" className="w-64 p-0">
              <div className="py-2">
                <h3 className="px-3 py-1 text-sm font-medium text-gray-700">
                    ...
                    <div className="space-y-1">
                      {predefinedMessages.map((item) => (
                        <div
                          ...
                          onClick={() =>
                            handleSelectPredefinedMessage(item.message)
                          }
                        >
